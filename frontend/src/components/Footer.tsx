    ...
    <>
      <footer className="w-full flex-center flex-col bg-background border-t-4 border-sky-900">
        ...
        <section className="px-8 py-6">
          <p className="text-center text-stone-700 md:text-base text-xs">
        ...
        <section className="p-2 w-full border-t border-stone-400 flex-center flex-col">
          <span className="text-stone-900 md:text-base text-sm">Contact with the Developer</span>
          <section className="p-2 flex-center gap-4">
            <a
              ...
              rel="noreferrer"
            >
              <img src="github.png" alt="github" className="md:size-8 size-6 rounded-full bg-white" />
            </a>
            <a
              ...
              rel="noreferrer"
            >
              <img src="linkedin.png" alt="linkedin" className="md:size-8 size-6 rounded-full bg-white" />
            </a>
          </section>
        </section>
